  ...
  return (
    <div className="flex">
      <div
        ...
        className={`relative h-screen border bg-white duration-300 ${
      ...
      >
        ...
        <div className="border border-red-primary">
          <div className="flex items-center py-4 border rounded-r-full">
            <svg
              width="16"
              height="16"
              xmlns="http://www.w3.org/2000/svg"
              className="mr-4 fill-grey-light-tertiary"
            >
              <path
            ...
            <span className="text-base font-semibold text-grey-light-tertiary">
              Platform Launch
            </span>
          </div>
